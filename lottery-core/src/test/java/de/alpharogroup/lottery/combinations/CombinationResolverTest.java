...
public class CombinationResolverTest
{
	...
	/**
	 * Test the method
	 * {@link CombinationResolver#getAllPossibleCombinationsCount(int, int, int, int)}
	 */
	@Test
	public void testGetAllPossibleCombinationsCountWithFourParams()
	{
		...
		// new scenario...
		// compute the probability of eurojackpot
		actual = CombinationResolver.getAllPossibleCombinationsCount(50, 5, 10, 2);
		expected = 95344200;
		assertEquals(actual, expected);
	}
	...
	public void testGetPossibleCombinations()
	{
		...
		actual = CombinationResolver.getPossibleCombinations(firstCollection,
			firstCollectionCombinationSize, secondCollection, secondCollectionCombinationSize);
		expected = SetFactory.newHashSet();
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 4, 5, 6))
		...
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 5, 6))
				.secondCollection(SetFactory.newHashSet(1, 2)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 5, 6))
				.secondCollection(SetFactory.newHashSet(1, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 5, 6))
				.secondCollection(SetFactory.newHashSet(2, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 4, 6))
				.secondCollection(SetFactory.newHashSet(1, 2)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 4, 6))
				.secondCollection(SetFactory.newHashSet(1, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 4, 6))
				.secondCollection(SetFactory.newHashSet(2, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 4, 5))
				.secondCollection(SetFactory.newHashSet(1, 2)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 4, 5))
				.secondCollection(SetFactory.newHashSet(1, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 2, 3, 4, 5))
				.secondCollection(SetFactory.newHashSet(2, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(2, 3, 4, 5, 6))
				.secondCollection(SetFactory.newHashSet(1, 2)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(2, 3, 4, 5, 6))
				.secondCollection(SetFactory.newHashSet(1, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(2, 3, 4, 5, 6))
				.secondCollection(SetFactory.newHashSet(2, 3)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 3, 4, 5, 6))
				.secondCollection(SetFactory.newHashSet(1, 2)).build());
		expected.add(
			DoubleSetBox.<Integer> builder().firstCollection(SetFactory.newHashSet(1, 3, 4, 5, 6))
				.secondCollection(SetFactory.newHashSet(1, 3)).build());
		...
		assertEquals(expected.size(), actual.size());
		assertTrue(CollectionExtensions.isEqualCollection(actual, expected));
		long allPossibleCombinationsCount = CombinationResolver.getAllPossibleCombinationsCount(
			firstCollection.size(), firstCollectionCombinationSize, secondCollection.size(),
