 ...
 * for the game seventyseven with {@link SecureRandom} argument for custom randomize draws, like for
 * a special draw date we could initialize the {@link SecureRandom} with the draw date.
 */
