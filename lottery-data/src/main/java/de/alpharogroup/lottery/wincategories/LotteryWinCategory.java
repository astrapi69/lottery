...
public enum LotteryWinCategory implements WinningOpportunity
{
	...
	EIGHTH_CLASS(WinCategory.builder().quotaOfProfit(45.0d).quantityOfWonNumbers(3)
		.withSuperNumber(false).build()),
	/** The fifth winning class. */
	FIFTH_CLASS(WinCategory.builder().quotaOfProfit(5.0d).quantityOfWonNumbers(4)
		.withSuperNumber(true).build()),
	/** The first winning class. */
	FIRST_CLASS(WinCategory.builder().quotaOfProfit(12.8d).quantityOfWonNumbers(6)
		.withSuperNumber(true).build()),
	/** The fourth winning class. */
	FOURTH_CLASS(WinCategory.builder().quotaOfProfit(15.0d).quantityOfWonNumbers(5)
		.withSuperNumber(false).build()),
	/** The ninth winning class. */
	NINTH_CLASS(WinCategory.builder().fixedWinningUnits(5).quantityOfWonNumbers(2)
		.withSuperNumber(true).build()),
	/** The none winning class. */
	NONE(null),
	/** The second winning class. */
	SECOND_CLASS(WinCategory.builder().quotaOfProfit(10.0d).quantityOfWonNumbers(6)
		.withSuperNumber(false).build()),
	/** The seventh winning class. */
	SEVENTH_CLASS(WinCategory.builder().quotaOfProfit(10.0d).quantityOfWonNumbers(3)
		.withSuperNumber(true).build()),
	/** The sixth winning class. */
	SIXTH_CLASS(WinCategory.builder().quotaOfProfit(10.0d).quantityOfWonNumbers(4)
		.withSuperNumber(false).build()),
